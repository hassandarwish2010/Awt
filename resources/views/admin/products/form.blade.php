  ...
  <div class="col col-md-6" style="display: none">
      <div class="white-box">
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-tag"></i></div>
                <input type="text" class="form-control" id="ar_name" placeholder="{{ __('lang.ar_name') }}" name="ar_name" value="anyname" required="required">
            </div>
            <div class="input-group">
      ...
      <div class="white-box">
          <div class="row">
              <div class="col-sm-12 col-xs-12">
                ...
                <textarea id="editor2" name="ar_details" rows="8" class="form-control" style="resize:vertical;width:100%;" placeholder="">anydetails</textarea>
