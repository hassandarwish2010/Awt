<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="{{ route('parteners.index') }}" class="waves-effect">
                <i class="fa fa-archive fa-fw"></i>
                <span class="hide-menu"> {{ __('lang.parteners') }} </span>
              </a>
            </li>
            ...
            {{--</li>--}}
            <li>
                <a href="{{ url('admin-panel/about/1/edit') }}" class="waves-effect">
                    <i class="fa fa-book fa-fw"></i>
                    <span class="hide-menu"> {{ __('lang.welcome') }} </span>
                </a>
            </li>

            <li>
            <li>
                <a href="{{ url('admin-panel/about/2/edit') }}" class="waves-effect">
                    <i class="fa fa-book fa-fw"></i>
                    <span class="hide-menu"> {{ __('lang.why') }} </span>
                </a>
            </li>
